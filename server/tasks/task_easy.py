    ...
    def __init__(self) -> None:
        super().__init__(
            TaskConfig(
                ...
                mission_brief="Stabilize a freshly deployed spacecraft, damp residual spin, and finish with enough fuel to hand over to the rest of the mission.",
                ...
                target_schedule=(
                    TimedTarget(
                        ...
                        instruction="Arrest deployment spin, damp each axis, then hold the comms attitude without burning unnecessary propellant.",
                        deadline_step=48,
                        milestone="bus_stabilized",
                        recommended_modes=("detumble", "trim", "hold"),
                        fuel_reserve_target=70.0,
                        completion_tolerance_deg=2.0,
                        completion_rate_tolerance_dps=0.15,
